...
(
    ...
    QRCode blob,
    TheLoaiSach varchar(500) not null,
...
-- modify TenSach text not null,
-- modify TacGia varchar(500) not null,
-- modify TheLoaiSach varchar(500) not null,
-- modify NhaXuatBan varchar(500) not null;
